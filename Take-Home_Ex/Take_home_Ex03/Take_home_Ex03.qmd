...
**7.1 For Correlation Analysis**

![The correlation analysis section allow users to dynamically explore relationships between water indicators and disease rates. Users can select specific diseases, water indicators and regions as well as the time periods through intuitive dropdown menus and sliders.](images/clipboard-3529100317.png)

![](images/clipboard-2937418237.png)

**7.2 ANOVA Analysis**

![](images/clipboard-3849518873.png)

The ANOVA analysis tab allows users to conduct statistical comparisons across multiple dimensions of water and disease data.

![](images/clipboard-1093960067.png)

**7.3 Bullet Chart**

![](images/clipboard-239874055.png)

The bullet charts section will provide an intuitive visual comparison view which can highlight specific regions for comparison, and trend data

![](images/clipboard-1984033805.png)
